  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h3 className="text-lg font-semibold mb-4">About TravelVerse</h3>
          <p className="text-gray-400">Discover the world with TravelVerse. We offer the best travel experiences at unbeatable prices.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-gray-400">Mars<br />Hellas Planitia(1400 miles)</p>
          <p className="text-gray-400 mt-2">Phone: 123456789<br />Email: info@travelverse.com</p>
        </div>
        <div>
      ...
      <div className="mt-8 border-t border-gray-700 pt-8 text-center">
        <p className="text-gray-400">&copy; 2023 TravelVerse. All rights reserved.</p>
      </div>
    </div>
  </footer>
  )
