...
const Header = ({ bgTransparent }: Prop) => {
  ...
  return (
    <header
      className={`${
        bgTransparent ? "bg-transparent" : "bg-indigo-900"
          ...
          >
            {isVerified ? (
              <>
                <Link
                  to="/myBookings"
                  className="flex text-black font-semibold justify-center items-center px-5 p-3 bg-white  rounded-lg hover:bg-slate-100"
                >
                  My Bookings
                </Link>
                <Link
